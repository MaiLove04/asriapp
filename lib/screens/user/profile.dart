...
class _profile_pageState extends State<profile_page> {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['success'] == true) {
          setState(() {
            ...
            if (nasabahData['foto'] != null &&
                nasabahData['foto'].toString().isNotEmpty) {
  ...
  String formatRupiah(int angka) {
    return "Rp " +
        angka.toString().replaceAllMapped(
        ...
        content: Column(
          ...
          children: [
            Text(
              ...
              textAlign: TextAlign.center,
              style: const TextStyle(fontSize: 13, color: greyTextColor),
            ),
            ...
            onPressed: () async {
              if (pinController.text.length == 6 &&
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text("PIN tidak cocok atau kurang dari 6 digit."),
  ...
  Future<void> _eksekusiSetupPin(String pin, String confirm) async {
    ...
    final result = await SetorSampahService.setupPin(
      pin: pin,
    ...
    if (mounted) {
      ...
      if (result['status'] == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(result['data']['message'] ?? "Gagal memproses PIN."),
            backgroundColor: Colors.red,
          ),
        );
      }
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.hasError ||
                  ...
                  return AlertDialog(
                    ...
                    content: const Text(
                      "Gagal mengambil data QR Code dari server.",
                    ),
                    actions: [
                      TextButton(
                        ...
                        try {
                          ...
                          if (context.mounted) {
                            ...
                            ScaffoldMessenger.of(this.context).showSnackBar(
                              const SnackBar(
                                content: Text(
                                  "✅ QR Code Berhasil Simpan ke Galeri!",
                                ),
                                backgroundColor: secondaryColor,
  ...
  Future<Map<String, dynamic>?> _fetchQrCodeData() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('${AppConfig.baseUrl}/barcode/nasabah'),
        headers: {
          "Accept": "application/json",
      ...
      if (response.statusCode == 200) {
        final data = jsonDecode(response.body);
        return {'success': true, 'barcode': data['barcode']};
      }
                        ...
                        children: [
                          Container(
                            ...
                            child: CircleAvatar(
                              ...
                              backgroundImage:
                                  fotoNasabah != null && fotoNasabah!.isNotEmpty
      ...
      bottomNavigationBar: Container(
        ...
        child: BottomNavigationBar(
          ...
          items: const [
            ...
            BottomNavigationBarItem(
              icon: Icon(Icons.add_circle_rounded, size: 24),
              label: "Mulai Setor",
            ),
            BottomNavigationBarItem(
...
class AppExitDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: const Text(
        "Apakah Anda yakin ingin keluar dari akun nasabah saat ini?",
      ),
      actions: [
        TextButton(
          onPressed: () => Navigator.pop(context),
